<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="javascript:void(0)">SEO-Verwaltung</a></li>
        </ol>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">SEO-Eintrag bearbeiten</h4>
                </div>
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="update">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.seo-manager') }}" class="btn btn-secondary">Zurück zur Tabelle</a>
                        </div>
                    </form>
                </div>
            </div>
