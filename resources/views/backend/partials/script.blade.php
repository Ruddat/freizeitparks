  ...
  <script src="{{ asset('assets/backend/vendor/vector-map/jquery-jvectormap-2.0.5.min.js') }}">></script>
  <script src="{{ asset('assets/backend/vendor/vector-map/jquery-jvectormap-world-mill.js') }}">></script>
