    ...
    <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <div class="flex space-x-4">
                <!-- Social Icons -->
                <a href="#" class="text-gray-300 hover:text-white transition">@svg('icons.fb')</a>
                <a href="#" class="text-gray-300 hover:text-white transition">@svg('icons.twitter')</a>
                <a href="#" class="text-gray-300 hover:text-white transition">@svg('icons.instagram')</a>
            </div>
        </div>
    </div>
