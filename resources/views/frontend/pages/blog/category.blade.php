...
<div class="bg-gradient-to-b from-blue-950 to-blue-900 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <!-- Sidebar -->
        <aside class="space-y-8 lg:pl-8 lg:border-l lg:border-white/10 sticky top-20">
            <!-- Neueste Beiträge -->
                ...
                <div class="space-y-2">
                    @foreach($categories as $cat)
                        <a href="{{ route('blog.category', ['slug' => $cat->slug]) }}"
                           class="flex justify-between items-center px-3 py-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200">
                            <span class="truncate">{{ $cat->name }}</span>
                            <span class="text-xs bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-white px-2 py-0.5 rounded-full">
